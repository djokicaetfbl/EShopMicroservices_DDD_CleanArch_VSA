namespace Ordering.Application.Orders.Commands.CreateOrder
{
    public class CreateOrderHandler(IApplicationDbContext dbContext) : ICommandHandler<CreateOrderCommand, CreateOrderResult>
    {
        public async Task<CreateOrderResult> Handle(CreateOrderCommand command, CancellationToken cancellationToken)
        {
            ...
            //save to database // !! trebao bi nam AplicationDbContext koji je razvijen u Infrastructure sloju, ali zbog clean arhitekture ne možemo direktno da ga koristimo ovde. Nasuprot Infratructure sloj koristi Application sloj, tako da bi trebalo da koristimo neki interfejs iz Application sloja koji će Infrastructure sloj implementirati (IAplicationDbContext).
            //return result
